...
jQuery(document).ready(function ( $ ){
	...
	function myTimer() {
		$('#playergraph').attr('src','https://bedrockinfo.com/data/smp.worldofsteelcraft.gq:25576');  /* Here */
		$.getJSON('https://api.bedrockinfo.com/v2/status?server=smp.worldofsteelcraft.gq&port=25576', function(data) { 
			$('#isonline').empty();
